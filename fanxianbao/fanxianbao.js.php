...
?>
var fanUser = '';
if (document.getElementById('fanxianbao')) fanUser = document.getElementById('fanxianbao').value;
var xiuMouseAble = false;
var xiuMouseX = 0;
var xiuMouseY = 0;
var xiuClientX = 0;
var xiuClientY = 0;
var xiuStrIframeUrl = "http://<?=URL?>/fanxianbao/fanxianbao.php?u="+fanUser+"";
...
if(taobao==1 || tmall==1){
	...
	writeDocument("http://<?=URL?>/fanxianbao/fanxianbao.php?u="+encodeURI(fanUser)+"&url="+encodeURIComponent(xiuStrUrl)+"&qkey="+encodeURI(xiuKeyText));
}
else{
    alert('此商品已下架或不是商品页');
}
