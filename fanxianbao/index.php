...
$broswer=isset($_GET['broswer'])?$_GET['broswer']:$browser_cur;
...
<li><a class="cur" href="fanxianbao/index.php"><h2>收藏版</h2><span>适用：所有浏览器，360急速浏览器，Firefox，Chrome，Opera等</span><b>只需收藏，安全方便，一键返现！</b></a></li>
<?php if($fanxianbao_right==1){?>
<li style="margin-right:0"><a class="normal" href="fanxianbao/right.php"><h2>右键版</h2><span>适用：IE内核，360安全浏览器，世界之窗等</span><b>下载安装，无需登录，一键返现！</b></a></li>
<?php }?>
</ul>
</div>
...
<li><a <?php if(strtolower($v)==strtolower($broswer)){?> class="cur"<?php }else{?> class="normal" <?php }?> href="fanxianbao/index.php?broswer=<?=strtolower($v)?>"><span class="<?=strtolower($v)?>"></span><?=$v?>浏览器</a></li>
<?php }?>
</ul>
</div>
<div class="right"><div class="clearfix"><div class="yixia">
<a title="<?=$webset['fxb']['name']?>" style="color:#FFF" onclick="return false" href="<?=$shoucang_code?>"><?=$webset['fxb']['name']?></a>
