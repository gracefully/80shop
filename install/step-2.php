...
$(document).ready(function(){
    ...
    $('#datapwd').blur(function(){
	    ...
	    var host=$('#host').val();
	    $.post("jiance.php", { "dataname": dataname,"datauser": datauser,"datapwd": datapwd,"host":host},function(data){
	        if(data==0){
		        $('#jieguo').html("&nbsp;数据库连接失败");
...
<td><input type="text" name="db[prefix]" value="duoduo_" size="35" class="txt"></td>
<td></td>
</tr>
</table>
<table class="tb2">
...
<div style="text-align:center"><a href="http://soft.duoduo123.com/show/install" target="_blank">查看视频安装教程</a> <a href="http://soft.duoduo123.com/help/inat" target="_blank">帮助中心</a></div>
