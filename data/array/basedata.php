<?php
 return array (
  ...
  array (
    ...
    'del' => 'tinyint(1) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `tao_id` (`tao_id`),KEY `trade_id` (`trade_id`),KEY `title` (`title`),KEY `cid` (`cid`),KEY `sort` (`sort`),KEY `del` (`del`)',
  ),
  'baobei_blacklist' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    'tao_id' => 'bigint(12) NOT NULL',
    'addtime' => 'int(10) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `tao_id` (`tao_id`)',
  ),
  'baobei_comment' => 
  array (
  ...
  array (
    ...
    'day' => 'int(8) NOT NULL',
    'weiyi' => 'varchar(30) NOT NULL',
    'fxje' => 'double(11,2) NOT NULL default "0.00"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `uid` (`uid`),KEY `iid` (`iid`),KEY `day` (`day`),UNIQUE KEY `weiyi` (`weiyi`)',
  ),
  'city' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `first_word` (`first_word`)',
  ),
  'cron' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `cid` (`cid`),KEY `lanmu` (`lanmu`),KEY `code` (`code`),KEY `price` (`price`),KEY `discount_price` (`discount_price`),KEY `shouji_price` (`shouji_price`),KEY `rate` (`rate`),KEY `level` (`level`),KEY `nick` (`nick`),KEY `user_id` (`user_id`),KEY `iid` (`iid`),KEY `endtime` (`endtime`),KEY `addtime` (`addtime`),KEY `sort` (`sort`),KEY `data_id` (`data_id`),KEY `del` (`del`),KEY `baoyou` (`baoyou`),KEY `xiajia` (`xiajia`)',
  ),
  'ddmall' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    ...
    'api_rule' => 'varchar(50) default NULL',
    'api_city' => 'varchar(255) default NULL',
    'type' => 'tinyint(1) NOT NULL default "1"',
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `cid` (`cid`),KEY `sort` (`sort`),KEY `adid` (`adid`),KEY `domain` (`domain`)',
  ),
  'ddtuiguang' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'content' => 'text default NULL',
    'jiangli' => 'int(1) NOT NULL default "0"',
    'data_id' => 'int(11) NOT NULL default "0"',
    'shuxing' => 'int(1) NOT NULL default "1"',
    'web' => 'int(2) NOT NULL default "1"',
    'mallname' => 'varchar(50) default NULL',
    'baoming' => 'int(1) NOT NULL default "0"',
    'price' => 'double(10,2) NOT NULL default "0.00"',
    'discount_price' => 'double(10,2) NOT NULL default "0.00"',
    'rate' => 'double(3,2) NOT NULL default "0.00"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `cid` (`cid`),KEY `username` (`username`),KEY `starttime` (`starttime`),UNIQUE KEY `data_id` (`data_id`),KEY `shuxing` (`shuxing`),KEY `web` (`web`),KEY `baoming` (`baoming`),KEY `price` (`price`)',
  ),
  'ddzhidemai_comment' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'del' => 'tinyint(1) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `memberid` (`memberid`),UNIQUE KEY `eventid` (`eventid`),KEY `del` (`del`)',
  ),
  'goods' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    ...
    'promotion_name' => 'varchar(20) default NULL',
    'volume' => 'int(11) NOT NULL default "0"',
    'credit' => 'int(11) default "1"',
    'promotion_price' => 'double(10,2) default "0.00"',
    'tuijian' => 'int(11) NOT NULL default "0"',
    'user_id' => 'int(11) NOT NULL default "0"',
    'shop_id' => 'int(11) NOT NULL default "0"',
    'baoyou' => 'tinyint(1) NOT NULL default "0"',
    'shop_title' => 'varchar(20) default NULL',
    'logo' => 'varchar(200) default NULL',
    'del' => 'tinyint(1) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `cid` (`cid`),UNIQUE KEY `iid` (`iid`),KEY `title` (`title`),KEY `nick` (`nick`),KEY `sort` (`sort`),KEY `addtime` (`addtime`),KEY `tuijian` (`tuijian`),KEY `baoyou` (`baoyou`),KEY `del` (`del`)',
  ),
  'huan_goods' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `mall_id` (`mall_id`),KEY `title` (`title`),KEY `sdate` (`sdate`),KEY `edate` (`edate`),KEY `sort` (`sort`),KEY `relate_id` (`relate_id`)',
  ),
  'income' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'del' => 'tinyint(1) NOT NULL default "0"',
    'domain' => 'varchar(30) default NULL',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `merchant` (`merchant`),KEY `cid` (`cid`),KEY `sort` (`sort`),KEY `edate` (`edate`),KEY `duomaiid` (`duomaiid`),KEY `yiqifaid` (`yiqifaid`),KEY `chanetid` (`chanetid`),KEY `del` (`del`),KEY `domain` (`domain`)',
  ),
  'mall_comment' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `uid` (`uid`),KEY `senduser` (`senduser`)',
  ),
  'msgset' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'auction_count' => 'int(11) NOT NULL default "0"',
    'sid' => 'int(11) NOT NULL default "0"',
    'title' => 'varchar(100) default NULL',
    'pic_path' => 'varchar(255) default NULL',
    'created' => 'datetime default NULL',
    'shop_click_url' => 'text default NULL',
    'type' => 'char(1) default "C"',
    'addtime' => 'int(11) NOT NULL default "0"',
    'hits' => 'int(11) default "0"',
    'sort' => 'int(11) NOT NULL default "0"',
    'item_score' => 'double(2,1) NOT NULL default "0.0"',
    'service_score' => 'double(2,1) NOT NULL default "0.0"',
    'delivery_score' => 'double(2,1) NOT NULL default "0.0"',
    'fanxianlv' => 'double(4,2) NOT NULL default "0.00"',
    'top' => 'tinyint(1) NOT NULL default "0"',
    'taoke' => 'tinyint(1) NOT NULL default "1"',
    'total_auction' => 'int(11) NOT NULL default "0"',
    'index_top' => 'tinyint(1) NOT NULL default "0"',
    'tao_top' => 'tinyint(1) NOT NULL default "0"',
    'del' => 'tinyint(1) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `nick` (`nick`),KEY `uid` (`uid`),KEY `cid` (`cid`),KEY `sort` (`sort`),KEY `index_top` (`index_top`),KEY `del` (`del`)',
  ),
  'slides' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'title' => 'varchar(255) default NULL',
    'img' => 'varchar(255) default NULL',
    'sdatetime' => 'bigint(11) NOT NULL default "0"',
    'edatetime' => 'bigint(11) NOT NULL default "0"',
    'value' => 'double(10,2) NOT NULL default "0.00"',
    'price' => 'double(10,2) NOT NULL default "0.00"',
    'rebate' => 'double(10,1) NOT NULL default "0.0"',
    ...
    'content' => 'text default NULL',
    'del' => 'tinyint(1) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `city` (`city`),KEY `title` (`title`),KEY `sort` (`sort`),KEY `salt` (`salt`),KEY `del` (`del`)',
  ),
  'tuan_type' => 
  array (
  ...
  array (
    ...
    'fxb' => 'tinyint(1) NOT NULL default "0"',
    ...
    'del' => 'tinyint(1) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `ddusername` (`ddusername`),KEY `loginnum` (`loginnum`),KEY `lastlogintime` (`lastlogintime`),KEY `alipay` (`alipay`),UNIQUE KEY `email` (`email`),KEY `money` (`money`),KEY `jifenbao` (`jifenbao`),KEY `jifen` (`jifen`),KEY `txstatus` (`txstatus`),KEY `dhstate` (`dhstate`),KEY `level` (`level`),KEY `tjr` (`tjr`),KEY `mobile` (`mobile`),KEY `ucid` (`ucid`),KEY `tbtxstatus` (`tbtxstatus`),KEY `platform` (`platform`),KEY `trade_uid` (`trade_uid`),KEY `del` (`del`)',
  ),
  'user_temp' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
