...
(function($, window, document, undefined) {
    ...
    $.fn.lazyload = function(options) {
        ...
        this.each(function() {
            ...
            var $self = $(self);
			if(PICJM==1){
				$self.attr("data-" + settings.data_attribute,decode64($self.attr("data-" + settings.data_attribute)))
			}
            self.loaded = false;
...
function callback(a){
	...
	$.ajax({
		...
		jsonp:"callback",
		success: function(data){
			key_1 = '【<b style="color:#F60;font-family:宋体;">'+key+'</b>】';
			for(var i in data){	
			...
			for(var k in sousuoxiala){
				str += "<li mod='"+sousuoxiala[k][0]+"' act='"+sousuoxiala[k][1]+"' style='font-family:宋体;'><a style='margin-left:10px; font-family:宋体;text-decoration:none' href='index.php?mod="+sousuoxiala[k][0]+"&act="+sousuoxiala[k][1]+"&q="+encodeURIComponent(key)+"' target='_blank'> 搜" + key_1 + " "+sousuoxiala[k][2]+"</a></li>";
			}
