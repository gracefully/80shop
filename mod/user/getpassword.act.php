...
function act_user_getpassword(){
	...
	if($step==2){
		...
		$html="请点击链接进入".WEBNAME."进行密码重置。有效时间10分钟。<a href=\"http://".URL."/index.php?mod=user&act=getpassword&step=3&str=".$string."\">http://".URL."/index.php?mod=user&act=getpassword&do=step3&str=".$string."</a>";
