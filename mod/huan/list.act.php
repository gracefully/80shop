...
function act_huan_list($pagesize=12,$field='id,img,jifen,jifenbao,title,num,sdate,edate'){
	...
	$huan=$duoduo->select_all('huan_goods',$field, "hide='0' and num>0 and del=0 and (edate=0 or edate>'".TIME."') and (sdate=0 or sdate<'".TIME."') ".$where." order by sort asc,id desc limit $frmnum,$pagesize");
