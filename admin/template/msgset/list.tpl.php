                  ...
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
					...
					<?php foreach ($row as $r){?>
					  <tr>
                        <td><?=$r["id"]?></td>
                        <td><?=$r["title"]?></td>
						<td><input type="checkbox" <?php if($r['web_open']!=0){?> checked="checked"<?php }?> disabled="disabled" /> 站内信<input type="checkbox" <?php if($r['email_open']!=0){?> checked="checked"<?php }?> disabled="disabled" /> 邮件<input type="checkbox" <?php if($r['sms_open']!=0){?> checked="checked" <?php }?> disabled="disabled" /> 短信</td>
