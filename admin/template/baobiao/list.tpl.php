...
<div class="explain-col">
	<table cellspacing="0" width="100%">
        <tr>本工具统计的是所有没有退款订单的数据可能会有些偏差，仅供参考！</tr>
    </table>
</div>
<br />
      ...
      <?php }?>
                    <tr>
                      ...
                      <th width="8%" style="color:#00F" title="游戏返利佣金的总和">游戏佣金</th>
                      <th width="8%" style="color:#90C" title="游戏返利佣金-给会员的佣金">游戏利润</th>
                      <th width="8%" style="color:#00F" title="任务返利佣金的总和">任务佣金</th>
                      <th width="8%" style="color:#90C" title="任务返利佣金-给会员的佣金">任务利润</th>
                      <th width="10%">操作</th>
                    </tr>
                       <tr style="background-color:#E9F2FB">
                        ...
                        <td style="color:#F00"><?=$list['gameyj']?></td>
                        <td style="color:#00F"><?=$list['gamelr']?></td>
					...
					<?php foreach ($row as $r){?>
					  <tr>
                       ...
                       <td><?=$r["date"]?></td>
                        ...
                        <td style="color:#00F"><?=(float)$r["gameyj"]?></td>
                        <td style="color:#90C"><?=(float)$r["gamelr"]?></td>
