...
<table width="99%" border="0" cellpadding="3" cellspacing="1" bgcolor="#D1DDAA">
  ...
  <tr bgcolor="#F2FFB5" align="center">
    ...
    <td width="15%">表名</td>
    <td width="8%">记录数</td>
    <td width="5%" style="position:relative">多余<div style="position:absolute; top:-68px; left:0px;"><div class="w">
<div class="x"><p><a>对于有多余碎片的表，可点击“优化”进行优化，刷新查看结果</a></p>
  ...
  ?>
    ...
    <td>
    <?php
	$a=$duoduo->show_states($tablename);echo round($a['Data_free']/1024,2).'kb';
	?>
    </td>
    <td>
  ...
  ?>
    ...
    <td>
    <?php
	$a=$duoduo->show_states($tablename);echo round($a['Data_free']/1024).'kb';
	?>
    </td>
    <td>
    <a href="javascript:" onClick="LoadUrl('dopost=opimize&tablename=<?php echo $t; ?>');">优化</a> |
  ...
  ?>
  <tr bgcolor="#F7F8ED">
    <td height="24" colspan="10"><strong>其它数据表：</strong>(<a href="<?=u(MOD,ACT,array('all_show'=>1))?>">显示全部</a>)</td>
  </tr>
  <?php if($all_show==1){?>
