...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB">
        <tr>
              ...
              <td width="" align="right">&nbsp;<?=select(array('0'=>'分享人','1'=>'购买人'),$se,'se')?><input type="text" name="q" value="<?=$q?>" />&nbsp;<input type="submit" value="搜索" /></td>
                  ...
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
					...
					<?php foreach ($tuiguang as $r){?>
					  <tr>
						<td><?=$r["fenxiangren"]?></td>
                        <td><?=$r["username"]?></td>
                        <td><a  class="ddnowrap" style="width:500px; " href="<?=$r['url']?>" target="_blank" title="<?=$r['title']?>">【<?=$r['type']?>】<?=$r["title"]?></a></td>
