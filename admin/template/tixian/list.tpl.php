...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB">
        <tr>
              <td width="320">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a class="link3" href="<?=u(MOD,ACT,array('type'=>2,'status'=>0))?>">[金额提现]</a> <a class="link3" href="<?=u(MOD,ACT,array('type'=>1,'status'=>0))?>">[集分宝提现]</a> <a target="_blank" class="link3" href="<?=u(MOD,ACT,array('daochu'=>1))?>">[导出集分宝]</a>&nbsp;<?php if($reycle==1){?><a href="<?=u(MOD,ACT)?>" class="link3">[站内列表]</a><?php }else{?><a href="<?=u(MOD,ACT,array('reycle'=>1))?>" class="link3">[回收站]</a><?php }?>  <?php if($sum!=''){ ?> <a href="https://shenghuo.alipay.com/send/payment/fill.htm" target="_blank" class="link3">[立即支付]</a>&nbsp;&nbsp;&nbsp;<?php if($type>0){?>需支出：<span style="color:#F00;"><?=$sum?></span> <?=$type_arr[$type]?><?php }?> <?php }?></td> 
              <td width="" align="right">&nbsp;<?=select($select_arr,$se,'se')?>：<input style="width:120px" type="text" name="q" value="<?=$q?>" />&nbsp;状态：<?=select($status_arr,$status,'status')?>&nbsp;类型：<?=select($type_arr,$type,'type')?>&nbsp;提现工具：<?=select($tool_arr,$tool,'tool')?>&nbsp;<input type="submit" value="搜索" /></td>
