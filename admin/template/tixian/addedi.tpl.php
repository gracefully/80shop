...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<?=$row['api_return']?><?=is_numeric($row['api_return'])?'（流水号）':''?> &nbsp;&nbsp;&nbsp;<span class="zhushi"><?php if($row['wait']==1){?><a style=" text-decoration:underline" href="<?=u(MOD,ACT,array('do'=>'cancel','id'=>$id))?>">撤销平台集分宝发放</a><?php }?>&nbsp;&nbsp;&nbsp;<a href="http://bbs.duoduo123.com/read-htm-tid-145592.html" target="_blank">查看错误介绍</a></span></td>
  </tr>
  <?php }?>
  <?php if($do=='no'){?>
  <tr>
