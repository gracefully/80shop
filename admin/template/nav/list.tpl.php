...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              ...
              <td width="" align="right">&nbsp;只显示父导航<label><input name="fu" type="checkbox" value="<?=$fu?>"/> </label>&nbsp;名称：<input type="text" name="q" value="<?=$q?>" />&nbsp;<input type="submit" value="搜索" /></td>
