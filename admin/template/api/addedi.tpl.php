...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  <tr>
    ...
    <td>&nbsp;<input name="title" type="text" id="title" value="<?=$row['title']?>"/> <?php if($row['code']=='qq'){?><span class="zhushi">应用注册地址：<a style="text-decoration:underline" href="http://connect.qq.com/intro/login/" target="_blank">http://connect.qq.com/intro/login/</a></span><?php }?></td>
  </tr>
  <tr>
