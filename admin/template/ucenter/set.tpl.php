...
<tr>
    ...
    <td>&nbsp;<?=html_radio(array('0'=>'关闭论坛整合','1'=>'UCenter整合','2'=>'phpwind整合'),$which_lt,'which_lt')?></td>
  </tr>
</table>
<br/>
...
<br />
  <tr>
    ...
    <td>&nbsp;<input name="url" type="text" id="url" value="" style="width:300px" /> <span class="zhushi">举例：http://bbs.duoduo123.com/uc_server</span></td>
  </tr>
  <tr>
...
<br />
  <tr>
    ...
    <td>&nbsp;<a href="<?=u(MOD,ACT,array('ucapiset'=>1))?>" style="color:#F00">切换到自动设置</a></td>
  </tr>
  <tr>
...
<br />
  <tr>
    ...
    <td>&nbsp;<b style="color:#F00">整合适用于phpwind8.7版本</b></td>
  </tr>
  <tr>
