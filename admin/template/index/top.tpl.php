  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="90px"><a href="http://faq.duoduo123.com/v8" target="_blank" class="top-bu-bg">帮助文档</a></td>
        <td width="90px"><a href="<?=u('fun','cache')?>" target="main" class="top-bu-bg">更新缓存</a></td>
        <td width="90px"><a href="../index.php" target="_blank" class="top-bu-bg">返回首页</a></td>
