...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB">
        <tr>
              <td width="500px"class="bigtext">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="<?=u(MOD,'addedi')?>" class="link3">[添加商品]</a>&nbsp;<a href="<?=u('tuan_goods','update')?>" class="link3">[团购商品更新]</a>&nbsp;<a href="<?=u('tuan_type','list')?>" class="link3">[团购类目管理]</a>&nbsp;<a href="<?=u('city','list')?>" class="link3">[城市管理]</a>&nbsp;<?php if($reycle==1){?><a href="<?=u(MOD,ACT)?>" class="link3">[站内列表]</a><?php }else{?><a href="<?=u(MOD,ACT,array('reycle'=>1))?>" class="link3">[回收站]</a><?php }?></td>
              <td width=""></td>
              <td width="700" align="right">商品名：<input type="text" name="q" value="<?=$q?>" style="width:110px"/>&nbsp;<?=select($malls,$mall_id,'mall_id')?>&nbsp;<input type="submit" value="搜索" />&nbsp;&nbsp;共有 <b><?php echo $total;?></b> 条记录&nbsp;&nbsp;</td>
            </tr>
      </table>
      ...
      <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
                    <tr>
                      ...
                      <th width="5%">折扣</th>
                      <th width="6%">购买人数</th>
                      <th width="4%"><a href="<?=u(MOD,'list',array('sort'=>'asc'))?>">排序</a></th>
                      <th width="6%">操作</th>
                    </tr>
