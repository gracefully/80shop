...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              <td width="20%">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="<?=u(MOD,'addedi')?>" class="link3">[新增类别]</a> </td>
              <td width="" align="right">类别名：<input type="text" name="q" value="<?=$q?>" />&nbsp;<input type="submit" value="搜索" /></td>
                  ...
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
					...
					<?php foreach ($row as $r){?>
					  <tr>
                        ...
                        <td><?=$r["title"]?></td>
						<td style="text-align:left; padding-left:5px"><?=$r["content"]?></td>
                        <td><?=$r["sort"]?></td>
