...
<table id="addeditable"  align="center" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
                        ...
                        <?=select(array('0'=>'模式0','1'=>'模式1','2'=>'模式2','3'=>'模式3'),REPLACE,'REPLACE')?>
                           <span class="zhushi">模式0为不替换，模式1为替换敏感词，模式2为停止网页，模式3模糊匹配拆分词组，并停止网页</span>
                         </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>&nbsp; <?=html_radio(array(0=>'关闭',1=>'开启'),$webset['paipai']['errorlog'],'paipai[errorlog]')?>&nbsp;<span class="zhushi">储存路径data/temp/paipai_error_log</span></td>
                      </tr>
                      <tr>
