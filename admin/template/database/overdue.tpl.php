...
<div class="bigtext">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<input type="submit"  value=" 一键 检 测 " /><label><input name="auto_del" value="1" style="vertical-align:middle;" type="checkbox" /><span style="vertical-align:middle;">同时删除</span></label><br/>&nbsp;共有 <b><?php echo $total;?></b> 条记录</div>
</div>
      ...
      <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
	    ...
	    <tr>
		  ...
		  <td><?=$webset['ddgoodslanmu'][$r["code"]]?></td>
        ...
        <div style="position:relative; padding-bottom:10px">
            <input type="hidden" name="mod" value="ddgoods" /><input type="hidden" name="act" value="del" />
