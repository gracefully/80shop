...
<br/>
<?php if($do==''){?>
<form action="index.php?mod=<?=MOD?>&act=<?=ACT?>" method="post" onsubmit="return subF()" name="form1">
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr class="smsopen">
    ...
    <td>&nbsp;<input id="sms_pwd" name="sms[pwd]" readonly="readonly" style="width:80px" value="<?=$webset['sms']['pwd']?>" /> <button class="sub" id="getddshouquan">获取数据</button> <span class="zhushi"><a href="<?=DD_OPEN_JFB_REG_URL?><?=urlencode(URL)?>">登录平台</a></span></td>
  </tr>
  <tr class="smsopen">
    <td align="right">短信签名：</td>
    <td>&nbsp;<input id="sms_sign" name="sms[sign]" style="width:80px" value="<?=$sms_sign?>" /><span class="zhushi">网站名称，最长4个字符（中文数字字母都个算一个字符）</span></td>
  </tr>
  <tr class="smsopen"><td colspan="2"><hr/></td></tr>
  <tr class="smsopen">
