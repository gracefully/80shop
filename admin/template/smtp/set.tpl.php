...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<?=html_radio($xingshi,$webset['smtp']['xingshi'],'smtp[xingshi]')?> <span class="zhushi">一般选择后台形式，如果发现服务器反映过慢，选择直接形式。</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input id="smtpuser" name="smtp[name]" value="<?=$webset['smtp']['name']?>" />&nbsp;<span class="zhushi">您的邮箱用户名，如service@duoduo123.com。</span></td>
  </tr>
  <tr>
    <td align="right">密码：</td>
    <td>&nbsp;<?=limit_input("smtp[pwd]")?>&nbsp;<span class="zhushi">您的邮箱密码，点击激活修改。</span></td>
  </tr>
  <tr>
