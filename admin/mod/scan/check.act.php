...
$suffix='php|inc|asp';
$ignore_filename=$admin_name.'/mod/scan/check.mod.php|/comm/ddUpgrade.class.php|/comm/alimama.class.php|/mod/api/tb.act.php|/comm/class.phpmailer.php|/comm/dd.func.php|/comm/Taoapi_Util.php|/comm/upload.class.php|/kindeditor/php/JSON.php|/uc_client/client.php|/uc_client/model/base.php|/comm/collect.class.php|/api/kaixin/kxHttpClient.php|/api/qq/comm/utils.php|/api/sina/saetv2.ex.class.php|/api/sina/weibooauth.php|'.$admin_name.'/mod/webserver/set.act.php|'.$admin_name.'/template/tradelist/taodianjin.tpl.php'; 
