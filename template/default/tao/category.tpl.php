<div id="m_cat">
			...
			<dl onmouseover="this.className='on'" onmouseout="this.className=''">
			<dt><a href="<?=u('tao','list',array('cid'=>0,'q'=>'数码家电'))?>" target="_blank" class="tt t_2">数码家电</a><span class="text orange"><em><span>
			...
			<dl onmouseover="this.className='on'" onmouseout="this.className=''">
			<dt><a href="<?=u('tao','list',array('cid'=>0,'q'=>'美容护发'))?>" target="_blank" class="tt t_3">美容护发</a><span class="text orange"><em><span>
			...
			<dl onmouseover="this.className='on'" onmouseout="this.className=''">
			<dt><a href="<?=u('tao','list',array('cid'=>0,'q'=>'家居建材'))?>" target="_blank" class="tt t_5">家居建材</a><span class="text orange"><em><span>
