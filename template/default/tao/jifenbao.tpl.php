...
#jmain .jfb_top { 
    background:url(<?=TPLURL?>/images/jfb_01.png);
	width:998px; 
	height:193px; 
	margin-left:-24px;
}
...
<div class="biaozhun5" style="width:1000px; background:#FFF;  margin:auto; margin-top:10px; padding-bottom:10px">
	<div id="jmain" style="width:950px; margin:auto;">
        ...
        <div class="qa">
			...
			<p><?=TBMONEY?>是由<?=WEBNAME?>特有的一种积分服务，具有现金价值。
				<br/>主要通过以下几种方式获得：
				<br/>1、购物返利得<?=TBMONEY?>；
		...
		<div class="qa">
			...
			<p>集分宝是由支付宝提供的积分服务，具有现金价值，100个集分宝可抵扣1元钱。
				<br/>集分宝可以<span class="link">直接当现金花</span>，而且用途范围很广。主要有以下几种：
				<br/>1、支持在淘宝网、天猫商城等网站抵现金购物；
				<br/>2、支持还信用卡、缴水电煤；
				<br/>3、兑彩票/礼品；
		...
		<div class="qa">
			<li><h2>如何使用集分宝？</h2></li>
			<p>集分宝使用场景较多，在支付宝收银台付款时，可抵扣相应现金。主要推荐以下使用方式：
			<br/><br/><img src="<?=TPLURL?>/images/jfb_07.png" width="631" height="33" alt="" /><br/>
			</p>
		</div>
        <div class="qa">
		...
		<p>您可以到淘宝网、天猫商城等网站购物，还可以通过支付宝还信用卡、缴水电煤。付款操作进行到支付宝收银台页面 时便均可进行抵现操作。
			<br/><img src="<?=TPLURL?>/images/jfb_10.png" width="718" height="476" alt="" />
		</p>
 		<h3>2、支付宝付款</h3>
		<p>进入到支付宝收银台后，页面上部会显示可用集分宝数量(余额满10个便可抵现)，点击“使用”链接。
			<br/><img src="<?=TPLURL?>/images/jfb_14.png" width="724" height="298" alt="" />
		</p>
 		<h3>3、集分宝抵扣现金</h3>
		<p>输入要抵现的集分宝数量，点击“确定”按钮。
			<br/><img src="<?=TPLURL?>/images/jfb_17.png" width="717" height="383" alt="" />
		</p>
		<h3>4、抵扣后支付余额</h3>
		<p>
			系统自动换算抵扣金额，您可以继续往下付款，输入兑换后需支付的余额。
			<br/><img src="<?=TPLURL?>/images/jfb_21.png" width="716" height="313" alt="" />
		</p>
		<h3>5、付款成功</h3>
		<p>
			大功告成，付款成功后集分宝对应数量将自动扣除。如果付款失败，集分宝将不会扣掉，可以继续使用。
			<br/><img src="<?=TPLURL?>/images/jfb_23.png" width="719" height="316" alt="" />
		</p>
