...
<form action="<?=SITEURL?>/index.php">
  ...
  <tr>
    ...
    <td align="right" width="" style="padding-right:3px"><a href="<?=$showpic_list1?>" class="noline"><img src="<?=TPLURL?>/images/list1<?=$list?>.gif" alt="小图片模式"  /></a>&nbsp;<a href="<?=$showpic_list2?>" class="noline"><img src="<?=TPLURL?>/images/list2<?=$list?>.gif" alt="大图片模式"  /></a></td>
  </tr>
</table>
</form>
