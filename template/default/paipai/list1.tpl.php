<div class="goodslist_main" id="splistbox">
                    ...
                    <li class="info">
                        ...
                        <div class="goodslist_main_right">
                            ...
                            <p class="fxje"> 可返现<span class="greenfont"><?=$thegoods["fxje"]?></span> 元 </p> 
                            <?php }else{?>
                            ...
                            <div class="goodslist_main_right_tb">
                                <a target="_blank" href="<?=u(MOD,ACT,array('q'=>$thegoods["title"]))?>"><div class="goodslist_main_right_bj"></div></a>
                    ...
                    <?php foreach($goods as $row) {?>
                        ...
                        <div class="goodslist_main_right">
                            ...
                            <div style="clear:both"></div>
                            <div class="goodslist_main_right_tb">
                                <a target="_blank" href="<?=u(MOD,ACT,array('q'=>$row["title"]))?>"><div class="goodslist_main_right_bj"></div></a>
