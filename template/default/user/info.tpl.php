...
$(function(){
	...
	$('#get_mobile_yzm').click(function(){
		...
		if(regMobile(mobile)==false){
			...
			$.ajax({
		    	url:'<?=l(MOD,ACT,array('do'=>'mobile','send_yzm'=>1))?>&time=<?=TIME?>',
				dataType:'json',
				type: "POST",
        	...
        	<div class="adminright">
                ...
                <div class="admin_xfl">
                  <ul>
                    ...
                    <li id="tbnick"><a href="<?=u('user','info',array('do'=>'tbnick'))?>">淘宝帐号绑定</a> </li>
...
<?php }?>
    ...
    <?php if($dduser['mobile_test']==1){?>
		<tr>
		  ...
		  <td width="25%"><?=show_mobile($dduser['mobile'])?></td>
		  <td style=" padding-left:10px"><div style="cursor:pointer" id="change" class="img-button"><p><input type="button" value="更改手机号码"/></p></div><div style="display:none" class="img-button"><p><input id="get_mobile_yzm" disabled type="button" value="获取验证码"/></p></div></td>
		</tr>
    <?php }?>
        ...
        <tr class="change">
		  ...
		  <div class="img-button"><p><input id="get_mobile_yzm" disabled type="button" value="获取验证码"/></p></div>
		  <?php }?>
          </td>
    ...
    <table border="0" align="left" cellpadding="0" cellspacing="0" bordercolorlight="#9acd32" class="no_table">
		...
		<tr>
		  <td width="18%" height="35" style="text-align:right">已验证手机号 *&nbsp;&nbsp;&nbsp;</td>
		  <td width="25%"><?=show_mobile($dduser['mobile'])?></td>
		  <td style=" padding-left:20px"><div class="img-button"><p><input id="get_mobile_yzm" disabled type="button" value="获取验证码"/></p></div></td>
		</tr>
        <tr>
		  <td height="35" style="text-align:right">短信验证码 *&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="yzm" id="yzm" style="width:130px;" class="ddinput"/></td>
        ...
        <tr>
		  <td height="35" style="text-align:right">金额提现平台 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		  <td><?=html_radio($txtool_arr,$dduser['txtool'],'txtool')?></td>
		  <td id=""><label class="field_notice">商城返利和拍拍返利的提现平台选择</label></td>
		</tr>
        <?php }?>
		<tr>
		  <td height="35">&nbsp;</td>
...
<?php }elseif($do=='tbnick'){?>
    ...
    <?php foreach($tbnick_arr as $k=>$v){?>
        <tr>
		  <td height="35" style="text-align:right">淘宝账号 *&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="tbnick[<?=$k?>]" type="text" id="tbnick_<?=$k?>" value="<?=$v?>" style="width:130px;" class="ddinput"/></td>
		  <td><label class="field_notice"></label><label id="checking_tbnick_<?=$k?>" class="checking">检查中...</label></td>
		</tr>
    <?php }?>
		<tr>
		  <td height="35">&nbsp;</td>
