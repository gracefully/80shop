    	...
    	<div class="adminmain">
        	...
        	<div class="adminright">
                ...
                <div class="admin_xfl">
                    ...
                    <li id="gametask"><a href="<?=u('user','tradelist',array('do'=>'gametask'))?>">游戏返利订单</a> </li>
                    <?php }?>
                    <?php if($webset['task']['status']==1){?>
                    <li id="task"><a href="<?=u('user','tradelist',array('do'=>'task'))?>">任务返利订单</a> </li>
                    <?php }?>
                    </ul>
              	</div>
                ...
                <div class="adminright_yuye">
                    ...
                    <?php if($do=='taobao'){?>
                    <p>亲！淘宝订单需要确认收货后，<?=WEBNAME?>最晚隔天会收到数据反馈！</p>
                    <?php }elseif($do=='mall'){?>
