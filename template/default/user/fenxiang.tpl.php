    	...
    	<div class="adminmain">
        	...
        	<div class="adminright" style="padding-top:10px">
                ...
                <?php foreach($baobei as $row){?>
                   <table width="770" border="0" cellspacing="0" cellpadding="0" class="admin_table_fx">
                      <tr>
                        <td width="105" height="90" align="center"><a target="_blank" href="<?=u('zhidemai','view',array('id'=>$row['id']))?>"><img src="<?=$row['img']?>" alt="<?=$row["title"]?>" /></a></td>
                        <td width="665">
                        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="27"><a target="_blank" href="<?=u('zhidemai','view',array('id'=>$row['id']))?>"><?=$row["title"]?></a></td>
                          </tr>
                          <tr>
